...
-- | Like D (not E), but with Ok k (*not* discriminating on a)
...
type OkLM' s a = (Num s, OkLF (V s a))
...
instance (Cartesian k, Cartesian k') => Cartesian (k :**: k') where
  exl :: forall a b. Ok2 (k :**: k') a b => Arr (k :**: k') (a :* b) a
  exl = -- exl :**: exl
        exl @k @a @b :**: exl @k' @a @b
  exr :: forall a b. Ok2 (k :**: k') a b => Arr (k :**: k') (a :* b) b
  exr = -- exr :**: exr
        exr @k @a @b :**: exr @k' @a @b
  (&&&) :: forall a c d. Ok3 (k :**: k') a c d
        => Arr (k :**: k') a c -> Arr (k :**: k') a d -> Arr (k :**: k') a (c :* d)
  (f :**: f') &&& (g :**: g') =
    -- (f &&& g) :**: (f' &&& g')
    ((&&&) @k @a @c @d f g :**: (&&&) @k' @a @c @d f' g')

instance (OkCoprod k, OkCoprod k')
      => OkCoprod (k :**: k') where
  okCoprod :: forall a b. Ok2 (k :**: k') a b :- Ok (k :**: k') (a :+ b)
  okCoprod = Sub $ Dict
                   <+ okCoprod @k  @a @b
                   <+ okCoprod @k' @a @b

instance (Cocartesian k, Cocartesian k') => Cocartesian (k :**: k') where
  inl :: forall a b. Ok2 (k :**: k') a b => Arr (k :**: k') a (a :+ b)
  inl = -- inl :**: inl
        inl @k @a @b :**: inl @k' @a @b
  inr :: forall a b. Ok2 (k :**: k') a b => Arr (k :**: k') b (a :+ b)
  inr = -- inr :**: inr
        inr @k @a @b :**: inr @k' @a @b
  (|||) :: forall a c d. Ok3 (k :**: k') a c d
        => Arr (k :**: k') c a -> Arr (k :**: k') d a -> Arr (k :**: k') (c :+ d) a
  (f :**: f') ||| (g :**: g') =
    -- (f ||| g) :**: (f' ||| g')
    ((|||) @k @a @c @d f g :**: (|||) @k' @a @c @d f' g')

instance (OkExp k, OkExp k')
      => OkExp (k :**: k') where
  okExp :: forall a b. Ok2 (k :**: k') a b :- Ok (k :**: k') (a -> b)
  okExp = Sub $ Dict
                <+ okExp @k  @a @b
                <+ okExp @k' @a @b

instance (CartesianClosed k, CartesianClosed k')
      => CartesianClosed (k :**: k') where
  apply :: forall a b. Ok2 (k :**: k') a b => Arr (k :**: k') ((a -> b) :* a) b
  apply = -- apply :**: apply
          apply @k @a @b :**: apply @k' @a @b
  curry :: forall a b c. Ok3 (k :**: k') a b c
        => Arr (k :**: k') (a :* b) c -> Arr (k :**: k') a (b -> c)
  curry (f :**: f') = -- curry f :**: curry f'
                      curry @k @a @b @c f :**: curry @k' @a @b @c f'
  uncurry :: forall a b c. Ok3 (k :**: k') a b c
          => Arr (k :**: k') a (b -> c) -> Arr (k :**: k') (a :* b) c
  uncurry (g :**: g') = -- uncurry g :**: uncurry g'
                        uncurry @k @a @b @c g :**: uncurry @k' @a @b @c g'
